...
export default function LoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (result?.error) {
      ...
      // The redirect is handled in the server action, but just in case:
  ...
  return (
    <div className="bg-[#0e0e0e] text-[#f9f6f5] antialiased selection:bg-[#ffd709] selection:text-[#5b4b00] min-h-screen flex flex-col overflow-x-hidden font-body">
      <main className="flex-grow flex flex-col md:flex-row relative">
        ...
        {/* Left Visual Content (Desktop Only) */}
          ...
          <div className="w-full max-w-md">
            ...
            <div className="md:hidden flex flex-col items-center mb-10">
              <div className="flex items-center gap-2 mb-2">
                <span className="material-symbols-outlined text-[#6c5a00] text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>bolt</span>
                <span className="font-headline font-black text-3xl italic tracking-tighter text-[#0e0e0e]">THUNDER</span>
              </div>
        ...
        {/* Visual Element: Floating Gradient Blob for Content Depth */}
