...
// Semantic tag & category mapper based on restaurant keywords
...
function SearchContent() {
    ...
    async function fetchRestaurants() {
      ...
      try {
        const { data, error } = await supabase
          .from("restaurants")
          .select("*")
          .eq("is_verified", true); // Only display verified restaurants
  ...
  // Map database restaurants to view model properties
